...
class AuthRepositoryImpl implements AuthRepository {
  ...
  Future<void> storeUserData(UserModel user) async {
    await SecureStorageService.saveUserFirstName(user.firstName);
    await SecureStorageService.saveUserLastName(user.lastName);
  ...
  Future<String?> getUserFirstName() {
    return SecureStorageService.getUserFirstName();
  }
}
