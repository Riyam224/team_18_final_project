...
class SessionManager {
  ...
  static Future<void> startSession() async {
    ...
    await AuditLogService.log(type: 'session', message: 'Session started');
  }
  ...
  static Future<void> checkSessionValidity() async {
    ...
    if (!isValid && _isSessionActive) {
      await endSession();
      await AuditLogService.log(type: 'session', message: 'Session expired');
  ...
  static Future<void> endSession() async {
    ...
    _sessionTimer = null;
    _lastActivity = null;
    await AuditLogService.log(type: 'session', message: 'Session ended');
  }
  ...
  static Future<void> completeLogout() async {
    ...
    await AuditLogService.log(type: 'auth', message: 'User performed complete logout');
  }
  ...
  static Future<void> setSessionTimeout(int minutes) async {
    ...
    await AuditLogService.log(type: 'session', message: 'Session timeout set to $minutes minutes');
