...
* Security features (root detection, screenshot prevention)
...
* **Authentication** with biometric login (Face ID / Touch ID)
* **Security Features**: root detection, screenshot prevention, app lock
